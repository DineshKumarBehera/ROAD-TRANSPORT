...
public class TransferItemAudit implements Serializable {
    ...
    @Column(name = "TSFR_AGT_ATTN_NAME")
    ...
    @Column(name = "ORGNAL_DLE_ACCT_TP")
    private String originalDleAccountType;

    @Column(name = "ORGNL_DLE_ACT_CHK_DIGIT")
