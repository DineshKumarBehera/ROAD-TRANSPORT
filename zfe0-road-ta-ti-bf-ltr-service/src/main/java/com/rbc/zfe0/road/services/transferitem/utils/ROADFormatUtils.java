 ...
 * @author Tim Tracy
 */
public class ROADFormatUtils {

    private ROADFormatUtils() {
        // no instances
    }
     ...
     * quietly returned. If the length of <code>phoneNumber</code> is greater
     * than {@link Constants#LENGTH_PHONE_NUMBER}, only the first 10 characters
     * will be returned. If the length of <code>phoneNumber</code> is less
     * than {@link Constants#LENGTH_PHONE_NUMBER}, <code>phoneNumber</code> is
     * quietly returned.
     *
     * @param phoneNumber
     * @return
    ...
    public static String formatSSN(String ssn) {
        ...
        if (ssn != null && ssn.length() == Constants.LENGTH_ACCOUNT_TAX_ID) {
            formattedSsn = ssn.substring(0, 3) + "-" + ssn.substring(3, 5) +
                    "-" + ssn.substring(5);
        }
    ...
    public static String formatCusip(String cusip) {
        ...
        if (StringUtils.isNotBlank(cusip) && cusip.length() == Constants.LENGTH_CUSIP) {
            formattedCusip = cusip.substring(0, 6) + "-"
                    + cusip.substring(6, 8) + "-" + cusip.substring(8);
        }
    ...
    public static String formatAccountNumber(String accountNumber) {
        String formattedAccountNumber = accountNumber == null ? "" : accountNumber.replaceAll("-", "");
    ...
    public static String formatAccountNumber(String accountNumberIn,
                                             String accountType, String checkDigit) {
    ...
    /**
     * Returns a formatted String version of a Date if the date passed in is not null and the
     * date format passed in is not null.
     *
    ...
    /**
     * null safe BigDecimal toString().  Returns the result of the toString() method on a BigDecimal
     * passed in if the BigDecimal is not null, otherwise returns an empty String ("").
     *
     * @return Returns the result of the toString() method on a BigDecimal
     * passed in if the BigDecimal is not null, otherwise returns an empty String ("").
     * @param-objectIn
     */
    ...
    /**
     * null safe Object toString().  Returns the result of the toString() method on an Object
     * passed in if the Object is not null, otherwise returns an empty String ("").
     *
     * @param objectIn
     * @return the result of the toString() method on an Object
     * passed in if the Object is not null, otherwise returns an empty String ("").
     */
